        ...
        <div class="max-w-md w-full space-y-8">
            ...
            <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-8">
                ...
                <div class="mt-6 p-4 bg-indigo-50 rounded-md">
                    <p class="text-xs font-semibold text-indigo-900 mb-2">Demo Credentials:</p>
                    <p class="text-xs text-indigo-700">Email: demo@example.com</p>
                    <p class="text-xs text-indigo-700">Password: password</p>
                </div>
            </div>
        </div>
    </div>
