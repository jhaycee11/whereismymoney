...
<div class="space-y-6">
    ...
    <div>
        ...
        <p class="text-sm text-gray-600">Welcome back! Here's your financial overview for this month.</p>
    </div>
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200">
            <div class="px-6 py-4 border-b border-gray-200">
                <div class="flex items-center justify-between">
                    ...
                    <a href="{{ route('dashboard.expenses') }}" class="text-sm font-medium text-indigo-600 hover:text-indigo-700">View All</a>
                </div>
            </div>
            <div class="divide-y divide-gray-200">
                ...
                @empty
                    <div class="px-6 py-8 text-center">
                        ...
                        <p class="mt-2 text-sm text-gray-500">No expenses yet</p>
                    </div>
                @endforelse
            </div>
        </div>
