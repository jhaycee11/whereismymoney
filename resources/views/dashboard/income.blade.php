        ...
        <div x-show="showFilters" 
            ...
            <form action="{{ route('dashboard.income') }}" method="GET" class="space-y-4">
                ...
                <div class="flex space-x-3">
                    ...
                    <a href="{{ route('dashboard.income') }}" class="inline-flex items-center px-4 py-2 bg-gray-200 text-gray-700 text-sm font-medium rounded-md hover:bg-gray-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500 transition">
                        <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    @forelse($incomes as $income)
                        <tr class="hover:bg-gray-50 transition">
                            ...
                            <td class="px-4 lg:px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                ...
                                <button onclick="IncomeManager.confirmDelete({{ $income->id }})" class="text-red-600 hover:text-red-900 transition">
                                    Delete
                                </button>
                            </td>
                        </tr>
...
<div id="incomeModal" class="modal-backdrop hidden fixed inset-0 bg-gray-900/50 overflow-y-auto h-full w-full z-50 px-4" onclick="IncomeManager.closeModalOnBackdrop(event)">
    <div class="modal-content relative top-10 sm:top-20 mx-auto p-4 sm:p-5 border border-gray-200 w-full max-w-md shadow-2xl rounded-lg bg-white mb-10 sm:mb-0" onclick="event.stopPropagation()">
        ...
        <!-- Modal Body -->
        <form id="incomeForm" method="POST" class="mt-4 space-y-4">
            @csrf
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <input type="number" 
                           ...
                           required
                           placeholder="0"
                           class="w-full pl-7 pr-3 py-2 border border-gray-300 rounded-md focus:ring-green-500 focus:border-green-500 text-sm">
                </div>
            </div>
            ...
            <!-- Date -->
            <div>
                <label for="income_date" class="block text-sm font-medium text-gray-700 mb-1">
            ...
            <div>
                ...
                <textarea id="notes" 
                          ...
                          class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-green-500 focus:border-green-500 text-sm"></textarea>
            </div>
